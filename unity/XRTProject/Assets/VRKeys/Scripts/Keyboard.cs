...
namespace VRKeys
{
    ...
    public class Keyboard : MonoBehaviour
    {
        ...
        [Space(15)] public TextMeshProUGUI placeholder;
        ...
        [Space(15)] public Color displayTextColor = Color.black;

        public Color caretColor = Color.gray;

        [Space(15)] public GameObject keyPrefab;
        ...
        [Space(15)] public string text = "";

        [Space(15)] public GameObject canvas;
        ...
        [Space(15)] public bool leftPressing = false;
        ...
        private void PositionAndAttachMallets()
        {
            ...
            leftMallet.transform.SetParent(leftHand.transform, false);
            ...
            rightMallet.transform.SetParent(rightHand.transform, false);
