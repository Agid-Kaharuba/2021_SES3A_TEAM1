    ...
    >
      ...
      <Grid container direction="column" alignItems="flex-start">
        <Container>
          ...
          <WhiteTextTypography>
            Our Team came up with the revolutionary idea that would transform
            the training sector completely with the help of Virtual Reality also
            the Technology of Future. Our team earlier this year came up with a
            great solution on how to train users in different industries. Our
            technology would allow users to look around themselves, walk up to
            close computer-generated objects, and interact with different items
          ...
          >
            <Card
              ...
              onClick={() => history.push("/aboutus/projectoutline")}
            >
              <CardActionArea>
                <CardMedia
            ...
            <Card
              className={classes.root}
              onClick={() => history.push("/aboutus/teamcommunication")}
            >
              <CardActionArea>
                <CardMedia
                  className={classes.media}
            ...
            <Card
              className={classes.root}
              onClick={() => history.push("/aboutus/vrexperience")}
            >
              <CardActionArea>
                <CardMedia className={classes.media} image={VrImage} />
                <CardContent>
                  <Typography gutterBottom variant="h5" component="h2">
                    VR experiences
                  </Typography>
            ...
            <Card
              className={classes.root}
              onClick={() => history.push("/aboutus/theteam")}
            >
              <CardActionArea>
                ...
                <CardContent>
                  ...
                  <Typography
                    ...
                    component="p"
                  >
                    Our team consist of three division: Unity team, Backend team
                    & Frontend team.
                  </Typography>
                </CardContent>
              </CardActionArea>
